...
<script>
  ...
  export default {
    name: 'App',
    // components:{ 'mf-header':Header, 'mf-footer':Footer}
  }
</script>
...
<!--<style>-->
  ...
  <!--.h_con .phone {-->
    <!--padding-left:23px;-->
    <!--background: url(../images/iconlist.png) 0 4px no-repeat;-->
  <!--}-->
  <!--.h_con ul li em {-->
    <!--color:#ccc;-->
    <!--font-style: normal;-->
  ...
  <!--.search button {-->
    <!--width: 32px;-->
    <!--background: url(../images/iconlist.png) 5px -96px no-repeat;-->
    <!--cursor: pointer;-->
  <!--}-->
  <!--.search button:hover {-->
  ...
  <!--.icon_home {-->
    <!--width:17px;-->
    <!--height: 15px;-->
    <!--background: url(../images/iconlist.png) 0 -130px no-repeat;-->
  ...
  <!--.icon_pd {-->
    ...
    <!--width:10px;-->
    <!--height:5px;-->
    <!--background: url(../images/iconlist.png) 0 -230px no-repeat;-->
    <!--margin-left:12px;-->
    <!--transition:all 0.3s;-->
  <!--}-->
  ...
  <!--.s_cart .icon_cart {-->
    <!--width:22px;-->
    <!--height: 16px;-->
    <!--background: url(../images/iconlist.png) 0 -160px no-repeat;-->
    <!--margin-right:10px;-->
    <!--display: inline-block;-->
    <!--vertical-align:middle;-->
    <!--margin-top:-3px;-->
  ...
  <!--.s_cart .icon_sj {-->
    <!--width:7px;-->
    <!--height: 4px;-->
    <!--background: url(../images/iconlist.png) 0 -250px no-repeat;-->
    <!--margin-left:10px;-->
    <!--display: inline-block;-->
    <!--vertical-align: middle;-->
    <!--margin-top:-2px;-->
  ...
  <!--.cart_dropdown ul li em {-->
    ...
    <!--width: 14px;-->
    <!--height: 14px;-->
    <!--background: url(../images/iconlist.png) 2px -298px no-repeat;-->
    <!--cursor: pointer;-->
  ...
  <!--.title {-->
    ...
    <!--font-weight: lighter;-->
    <!--padding-left:25px;-->
    <!--background: url("../images/iconlist.png") 0 -189px no-repeat;-->
    <!--line-height: 36px;-->
  ...
  <!--.ind_news>ul>li {-->
    <!--padding-left: 25px;-->
    <!--background: url(../images/iconlist.png) 9px -258px no-repeat;-->
    <!--line-height: 32px;-->
    <!--border-bottom: 1px dotted #ccc;-->
  <!--}-->
  <!--.ind_news>ul>li>span {-->
  ...
  <!--.breadcrumb h2 {-->
    ...
    <!--font-weight: lighter;-->
    <!--color: #666;-->
    <!--background: url(../images/iconlist.png) 0 -187px no-repeat;-->
  <!--}-->
  <!--.breadcrumb h2 a {-->
    <!--padding: 0 10px;-->
  <!--}-->
  ...
  <!--.login dl dd em {-->
    ...
    <!--width: 36px;-->
    <!--height: 36px;-->
    <!--background: #eaecef url(../images/iconlist.png) no-repeat;-->
  ...
  <!--.register>ul>li>strong {-->
    ...
    <!--margin-left: 14px;-->
    <!--cursor: pointer;-->
    <!--background:url(../images/iconlist.png) 0px -600px no-repeat;-->
  <!--}-->
