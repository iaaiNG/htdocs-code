...
####完善产品表设计添加几列
#cuid 创建者编号 ctime 创建时间
#muid 更新者编号 mtime 更新时间
alter table xz_laptop add cuid INT default 1;
alter table xz_laptop add ctime DATETIME default now();
alter table xz_laptop add muid INT default 1;
alter table xz_laptop add mtime DATETIME default 0;
#为表添加冗余字段
alter table xz_laptop add v1 VARCHAR(255) default '';
alter table xz_laptop add v2 VARCHAR(255) default '';
alter table xz_laptop add vi3 INT default 0;
alter table xz_laptop add vi4 INT default 0;